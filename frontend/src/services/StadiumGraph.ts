...
export class StadiumGraph {
  ...
  private initializeDefaultGraph(): void {
    const defaultZones: Zone[] = [
      ...
      { id: 'gate_4', name: 'Gate 4 (South)', type: 'gate', stepFree: false, status: 'open', capacity: 12000, currentOccupancy: 8000, x: 500, y: 950 },
      { id: 'gate_5', name: 'Gate 5 (South-West)', type: 'gate', stepFree: true, status: 'open', capacity: 15000, currentOccupancy: 5000, x: 250, y: 850 },
      { id: 'gate_6', name: 'Gate 6 (West)', type: 'gate', stepFree: true, status: 'open', capacity: 15000, currentOccupancy: 12000, x: 100, y: 500 },
      ...
      { id: 'concourse_s', name: 'Concourse South', type: 'concourse', stepFree: true, status: 'open', capacity: 25000, currentOccupancy: 22000, x: 500, y: 750 },
      ...
      { id: 'block_a1', name: 'Seating Block A1', type: 'seating', stepFree: false, status: 'open', capacity: 5000, currentOccupancy: 4200, x: 450, y: 350 },
    ...
    const defaultEdges: Edge[] = [
      ...
      { id: 'edge_cn_ba1', fromZoneId: 'concourse_n', toZoneId: 'block_a1', distanceMeters: 90, stepFree: false },
      { id: 'edge_cn_ba2', fromZoneId: 'concourse_n', toZoneId: 'block_a2', distanceMeters: 95, stepFree: true },
      { id: 'edge_cn_bd2', fromZoneId: 'concourse_n', toZoneId: 'block_d2', distanceMeters: 120, stepFree: true },

      { id: 'edge_ce_bb1', fromZoneId: 'concourse_e', toZoneId: 'block_b1', distanceMeters: 90, stepFree: false },
      { id: 'edge_ce_bb2', fromZoneId: 'concourse_e', toZoneId: 'block_b2', distanceMeters: 95, stepFree: true },
      { id: 'edge_ce_ba2', fromZoneId: 'concourse_e', toZoneId: 'block_a2', distanceMeters: 120, stepFree: true },

      { id: 'edge_cs_bc1', fromZoneId: 'concourse_s', toZoneId: 'block_c1', distanceMeters: 90, stepFree: false },
      { id: 'edge_cs_bc2', fromZoneId: 'concourse_s', toZoneId: 'block_c2', distanceMeters: 95, stepFree: true },
      { id: 'edge_cs_bb2', fromZoneId: 'concourse_s', toZoneId: 'block_b2', distanceMeters: 120, stepFree: true },

      { id: 'edge_cw_bd1', fromZoneId: 'concourse_w', toZoneId: 'block_d1', distanceMeters: 90, stepFree: false },
      { id: 'edge_cw_bd2', fromZoneId: 'concourse_w', toZoneId: 'block_d2', distanceMeters: 95, stepFree: true },
      { id: 'edge_cw_bc2', fromZoneId: 'concourse_w', toZoneId: 'block_c2', distanceMeters: 120, stepFree: true },

      { id: 'edge_cn_res1', fromZoneId: 'concourse_n', toZoneId: 'amenity_restroom_1', distanceMeters: 30, stepFree: false },
      { id: 'edge_ce_resacc1', fromZoneId: 'concourse_e', toZoneId: 'amenity_restroom_acc_1', distanceMeters: 40, stepFree: true },
